...
import generators.general as gen_general
import generators.dialogs as gen_dialogs
import generators.verbs_cloze as gen_cloze_verbs
import generators.words_cloze as gen_cloze_words
...
generators = [
    ...
    # {"name": "numbers", "call": gen_general.gen_cards, "expected": True, "args": ['db/numbers/numbers1.json', 'Kirjakielinen numerot - normaali', 'Suomi::Numerot::Kirjakielinen-1::normaali', 'Suomi_Kirjakielinen_1n.apkg', 'regular', 445256733, 902348237123]},
    # {"name": "numbers", "call": gen_general.gen_cards, "expected": True, "args": ['db/numbers/numbers1.json', 'Kirjakielinen numerot - käänteinen', 'Suomi::Numerot::Kirjakielinen-1::käänteinen', 'Suomi_Kirjakielinen_1k.apkg', 'reverse', 445256734, 902348237223]},
    ...
    # {"name": "Sanasto", "call": gen_general.gen_cards, "expected": True, "args": ['db/vocabulary/vocabulary1.json', 'Sanasto 1', 'Suomi::Sanasto::Sanasto-1', 'Suomi_Sanasto_1.apkg', 'regular', 445256744, 902348237323]},
    {"name": "cloze_verbs", "call": gen_cloze_words.gen_words_cloze, "expected": True, "args": [952344321, 'db/cloze_sets/adjektiivit.json', 'Finnish::Adjektiivit Cloze::Adjektiivit', 'Finnish_Words_Cloze_Adjektiivit.apkg']},
]
